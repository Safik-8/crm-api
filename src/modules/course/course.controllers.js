...
export const createCourse = async (req, res, next) => {
  try {
    ...
    return sendSuccess(res, { course }, "Service created successfully", 201);
  } catch (err) {
    next(err);
  }
};
...
export const getCourses = async (req, res, next) => {
  try {
    ...
    return sendSuccess(res, result, "Services fetched successfully");
  } catch (err) {
    next(err);
  }
};
...
export const getCourseById = async (req, res, next) => {
  try {
    ...
    return sendSuccess(res, { course }, "Service details fetched successfully");
  } catch (err) {
    next(err);
  }
};
...
export const updateCourse = async (req, res, next) => {
  try {
    ...
    return sendSuccess(res, { course }, "Service updated successfully");
  } catch (err) {
    next(err);
  }
};
...
export const toggleCourseStatus = async (req, res, next) => {
  try {
    ...
    return sendSuccess(res, { course }, `Service status set to ${status} successfully`);
  } catch (err) {
    next(err);
  }
};
